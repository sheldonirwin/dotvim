...
let g:colors_name = "Code School Java"

" term
" cterm
" ctermfg
" ctermbg
" gui		(e.g. underline, bold, ...)
" guifg 	(guifg=#000000 ~ gui foreground ~ actual text)
" guibg 	(guibg=#ffffff ~ gui background ~ background color)
